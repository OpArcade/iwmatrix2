...
interface InsideProjectBoxProps{
    data : any;
    setData : any;
    setOpen : any;
}
...
const InsideProjectBox = ({data,setData,setOpen}:InsideProjectBoxProps) => {
...
export default InsideProjectBox
