...
const About = () => {
  return (
    <AboutHomeContainer className='relative z-20 2xl:top-[40rem] xl:top-[40rem] lg:top-[35rem] top-[43rem]  p-2 mt-8 m-auto 2xl:w-4/5 xl:w-4/5 lg:w-3/4 md:max-lg:w-5/6'>
