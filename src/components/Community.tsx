...
const Community = () => {
  return (
   <CommunityContainer  className='relative z-30 md:w-[90%] m-auto top-[42rem] '>
...
<div className=''>
  <p className='text-[1em] max-sm:w-[85%] md:w-[70%] mx-auto text-center md:text-[1.4em] text-white'>
...
<div className='flex  flex-col lg:flex-row justify-center text-center items-center md:w-[75%] md:mt-6 w-full m-auto'>
         ...
         <div className='flex justify-center'>
          <img src="./assets/dev1.png" alt="" className='max-sm:w-[80%] md:w-[100%]' />
          </div>   
           </div>
...
<div className='  flex flex-col mt-11  justify-center text-center'>
          <div className="glitch-wrapper mb-[20px]">
